---
title: Campo elettrico e potenziale
feed: show
tags:
  - elettrostatica
---
...
Supponiamo di avere una carica fissa $Q$ e poniamo nei sui pressi una carica positiva $q_\text{test}$ ($q_\text{test} << Q$, la carica test è molto minore di $Q$).

La carica test si chiama così perché è usata per testare cosa accade.

## Campo elettrico

La carica test è soggetta a una forza di intensità $F_C = k \dfrac{\mid Q \mid \cdot \mid q_\text{test} \mid}{r^2}$ , dove $k \dfrac{\mid Q \mid}{r^2}$ è l'intensità del **campo elettrico** generato dalla carica $Q$ a una distanza $r$ e si indica con $E$. Quindi:

\\[E = k \dfrac{\mid Q \mid}{r^2} \, .\\]
...
Il **campo elettrico** è l'unione di tutti i vettori con intensità $E = k \dfrac{Q}{r^2}$ e direzione/verso indicata dal segno della carica sorgente.
