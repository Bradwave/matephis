...
2. Calcola la derivata delle seguenti funzioni.
	1. $f(x) = x^2 + 3$
	   [sol: $f^\prime(x) = 2x$]
	2. $f(x) = x - \sin x$
	   [sol: $f^\prime(x) = 1 - \cos x$]
	3. $f(x) = 3x^3 - 2x + 1$
	   [sol: $f^\prime(x) = 9x^2 - 2$]
	4. $f(x) = e^x + 5$
	   [sol: $f^\prime(x) = e^x$]
	5. $f(x) = \ln x$
	   [sol: $f^\prime(x) = \frac{1}{x}$]
	6. $f(x) = \cos x + x^2$
	   [sol: $f^\prime(x) = -\sin x + 2x$]
	7. $f(x) = 4x - 3$
	   [sol: $f^\prime(x) = 4$]
	8. $f(x) = k$, dove $k$ è un numero reale
	   [sol: $f^\prime(x) = 0$]
	9. $f(x) = 5x^4 - 4x^3 + 3x^2 - x$
	   [sol: $f^\prime(x) = 20x^3 - 12x^2 + 6x - 1$]
	10. $f(x) = \sin x + \cos x$
	    [sol: $f^\prime(x) = \cos x - \sin x$]
	11. $f(x) = ax^2 + bx$
	    [sol: $f^\prime(x) = 2ax + b$]
	12. $f(x) = 3
	    [sol: $f^\prime(x) = 0$]
...
4. **[EE/F]** Calcola la derivata delle seguenti funzioni.
	1. $f(x) = x \cdot \sin x$
	   [sol: $f^\prime(x) = \sin x + x \cdot \cos x$]
	2. $f(x) = x^2 \cdot e^x$
	   [sol: $f^\prime(x) = 2x \cdot e^x + x^2 \cdot e^x = e^x(2x + x^2)$]
	3. $f(x) = \ln(x) \cdot (2x^3)$
	   [sol: $f^\prime(x) = 2x^2 + \ln(x) \cdot (6x^2) = 2x^2(1 + 3\ln x)$]
	4. $f(x) = \dfrac{1}{x} \cdot \cos x$
	   [sol: $f^\prime(x) = -\frac{1}{x^2} \cdot \cos x - \frac{1}{x} \cdot \sin x = -\frac{1}{x}\left(\frac 1 x \cos x - \sin x\right)$]
	5. $f(x) = \sqrt{x} \cdot e^x$
	   [sol: $f^\prime(x) = \frac{1}{2\sqrt{x}} \cdot e^x + \sqrt{x} \cdot e^x = e^x\left(\frac{1 + 2x}{2\sqrt{x}}\right)$]
	6. $f(x) = \sin x \cdot \cos x$
	   [sol: $f^\prime(x) = \cos^2 x - \sin^2 x$]
	7. $f(x) = \sin x \cdot e^x$
	   [sol: $f^\prime(x) = \cos x \cdot e^x + \sin x \cdot e^x = e^x (\cos x + \sin x)$]
	8. $f(x) = e^x - 2x \cdot e^x$
	   [sol: $f^\prime(x) = e^x - 2 \cdot e^x - 2x \cdot e^x = -e^x (1 + 2x)$]
	9. $f(x) = 2x^2 - 3x + x \cdot \ln(x)$
	   [sol: $f^\prime(x) = 4x - 3 + \ln x + 1 = \ln x + 4x - 2$]
	10. $f(x) = \sin x - x \cos x$
	    [sol: $f^\prime(x) = \cos x - \cos x + x \cdot \sin x = x \cdot \sin x$]
