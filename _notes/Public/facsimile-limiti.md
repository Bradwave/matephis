---
title: Facsimile di una prova di verifica sui limiti
feed: show
tags:
  - facsimile
  - esercizi
...
1. $\lim_{x \, \to \, \dotsc} f(x) = +\infty$
2. $\lim_{x \, \to \, 2^-} f(x) = \; \dotsc$
3. $\lim_{x \, \to \, \dotsc} f(x) = 1$
4. $\lim_{x \, \to \, -\infty} f(x) = \; \dotsc$

![limiti-14]({{ site.baseurl }}/images/limiti-14.svg)
